...
<#
.SYNOPSIS
    Packages PhotoComp for Windows ARM64.
.DESCRIPTION
    Publishes a self-contained release build targeting win-arm64,
    then zips it into dist\PhotoComp-windows-arm64.zip.
.EXAMPLE
    .\build-windows-arm64.ps1
    .\build-windows-arm64.ps1 -Version "1.2.0"
#>
param(
...
$ZipName      = "$ProjectName-windows-arm64-v$Version.zip"
$ZipPath      = "$DistDir\$ZipName"

Write-Host ""
Write-Host "=== PhotoComp Windows ARM64 Packaging ===" -ForegroundColor Cyan
